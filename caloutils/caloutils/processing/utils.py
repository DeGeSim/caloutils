...
from torch_geometric.utils import scatter_max
...
def sum_duplicate_hits(batch: Batch, fake=True):
    ...
    cell_idxs = torch.arange(prod((calorimeter.num_z,calorimeter.num_alpha,calorimeter.num_r))).reshape(*(calorimeter.num_z,calorimeter.num_alpha,calorimeter.num_r))
