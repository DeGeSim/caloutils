...
To install caloutils, run this command in your terminal:

.. code-block:: console

    $ pip install caloutils

This is the preferred method to install caloutils, as it will always install the most recent stable release.
